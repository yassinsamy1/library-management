...
echo $library->addBook(1, "Software Engineering", "Jackson", "0060-1234567890") . "\n";
echo $library->addBook(2, "C++ Basics", "Othman", "0060-1187654321") . "\n";
echo $library->addMember(1, "Yassin", "Yassin@email.com") . "\n";
echo $library->addMember(2, "Samy", "samy@email.com") . "\n";
